  ...
  return (
    <div className='py-10 bg-settings'>
            <div className='pl-10 pb-5'>
                <img className='sm:w-20 tablet:w-32 animate-spin-slow' src='https://res.cloudinary.com/drecxkgks/image/upload/v1681127551/GERICHT%20-%20CHALLENGE%20FOLDER/Logo_qeldnf.png' alt="" />
            </div>
            <div className='flex sm:flex-col sm:items-center laptop:flex-row laptop:px-10 laptop:space-x-32'>
                <div className='text-white sm:w-3/4 tablet:w-1/2 laptop:w-1/2 flex flex-col justify-center items-center laptop:items-start desktop:space-y-10'>
                    ...
                    <div>
                        <div className='sm:space-y-3 sm:py-3 laptop:space-y-0 laptop:py-2 flex sm:flex-col laptop:flex-row'>
                            <div className='flex flex-row justify-between'>
                                <div className='flex justify-center items-center'>
                                    <img className='w-3/4' src='https://res.cloudinary.com/drecxkgks/image/upload/v1681127549/GERICHT%20-%20CHALLENGE%20FOLDER/Group1_w71jlc.png' alt="" />
                            ...
                            <div className='flex flex-row justify-between'>
                                <div className='flex justify-center items-center'>
                                    <img className='w-3/4' src='https://res.cloudinary.com/drecxkgks/image/upload/v1681127550/GERICHT%20-%20CHALLENGE%20FOLDER/Group2_vevwxe.png' alt="" />
                                    <div className='flex items-center justify-center absolute'>
                        ...
                        <div className='sm:space-y-3 sm:py-3 laptop:space-y-0 laptop:py-2 flex sm:flex-col laptop:flex-row'>
                            <div className='flex flex-row justify-between'>
                                <div className='flex justify-center items-center'>
                                    <img className='w-3/4' src='https://res.cloudinary.com/drecxkgks/image/upload/v1681127550/GERICHT%20-%20CHALLENGE%20FOLDER/Group5_exl6sr.png' alt="" />
                                    <div className='flex items-center justify-center absolute'>
                            ...
                            <div className='flex flex-row justify-between'>
                                <div className='flex justify-center items-center'>
                                    <img className='w-3/4' src='https://res.cloudinary.com/drecxkgks/image/upload/v1681127549/GERICHT%20-%20CHALLENGE%20FOLDER/Group3_orihoo.png' alt="" />
                                    <div className='flex items-center justify-center absolute'>
                ...
                <div className='sm:pt-6 laptop:pt-0 flex items-center justify-center relative'>
                    <img className='w-4/5' src='https://res.cloudinary.com/drecxkgks/image/upload/v1681127548/GERICHT%20-%20CHALLENGE%20FOLDER/chicken_wjyumi.jpg' alt="" />
                    <img className='absolute bottom-0 left-0 max-w-[50%]' src='https://res.cloudinary.com/drecxkgks/image/upload/v1681127549/GERICHT%20-%20CHALLENGE%20FOLDER/G_af7ric.png' alt="" />
                </div>
            </div>
        </div>
  )
