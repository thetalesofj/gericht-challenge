...
const Loader = () => {
  return (
    <div>
      ...
      <div className='flex items-center justify-center landscape:sm:pt-32 sm:pt-[23rem] landscape:mobile:pt-40 tablet:pt-[25rem] landscape:desktop:pt-[20rem] desktop:pt-[27rem]'>
